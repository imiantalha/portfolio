...
export default function Experience() {
  return (
    <section id="experience" className="bg-background py-12 sm:py-16 md:py-20">
        ...
        <div className="space-y-6">
          {experiences.map((experience) => (
            <article
              ...
              className="grid gap-4 rounded-lg border border-border bg-card p-5 shadow-sm sm:p-8 lg:grid-cols-[180px_1fr] lg:gap-8"
            >
